...
<?php echo form_open("mahasiswa/save") ?>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="tgl_lahir" name="tgl_lahir" type="text" value="<?php echo $obj_mahasiswa->tgl_lahir?>" class="form-control" spellcheck="false" data-ms-editor="true">
    </div>
  </div>
  <div class="form-group row">
    <label for="ipk" class="col-4 col-form-label">IPK</label> 
    <div class="col-8">
      <input id="ipk" name="ipk" type="text" value="<?php echo $obj_mahasiswa->ipk?>" class="form-control" spellcheck="false" data-ms-editor="true">
    </div>
  </div> 
  <div class="form-group row">
