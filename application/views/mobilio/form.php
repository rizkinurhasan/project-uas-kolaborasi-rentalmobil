    ...
    <div class="container">
      <div class="row">
        ...
        <div class="card">
          <div class="card-body">
            <div class="text-center">
              <img src="<?php echo base_url('assets/assets_shop')?>/assets/mobilio.jpg" class="rounded" alt="...">
              <h5>Honda Mobilio</h5>
              <form action="action-input-data.php" method="POST" name="form-input-data">
                <div class="row">
                  <div class="col">
                  <input class="form-control" type="text" placeholder="4 Penumpang" readonly>
                  </div>
                  <div class="col">
        ...
        <div class="col">
          ...
          <div class="card-body">
                            <div class="container">
                                <?php echo form_open("Mobilio/save") ?>
                                ...
                                <div class="form-group row">
                                    <div class="col-8">
                                        <input class="form-control" id="users_id" name="users_id" value="1" hidden>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-8">
                                    <input class="form-control" id="mobil_id" name="mobil_id" value="2" hidden>
                                    </div>
                                </div>
                                <div class="form-group row">
