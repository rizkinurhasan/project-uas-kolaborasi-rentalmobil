                        ...
                        <div class="card-body">
                            <div class="container">
                                ...
                                <div class="form-group row">
                                    <label for="tanggal_mulai" class="col-4 col-form-label">Tanggal Mulai Sewa</label>
                                    <div class="col-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="tujuan" name="tujuan" placeholder="Masukkan Tujuan Sewaan"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="noktp" name="noktp" placeholder="Masukkan Noktp " type="text"
                                ...
                                <div class="form-group row">
                                    <label for="mobil_id" class="col-4 col-form-label">Mobil Id
                                        Id</label>
                                    <div class="col-8">
